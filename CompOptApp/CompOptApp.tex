...
Fourth, the resulting score (number of superimposed alpha carbon atoms) is recorded in an
additional final alignment matrix, containing segment superposition scores.
Fifth, this matrix is then used to find the best alignment of whole proteins.
If no pair of segments did pass the filter sequence just described, the overall score is set to 0.
\begin{figure}[h]
\centering{
%\resizebox{0.5\textwidth}{!}{
\includegraphics[scale=0.35]{3dhitScalar}
}
%}
